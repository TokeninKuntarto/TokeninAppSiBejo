                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      MenuItem(
                        icon: Icons.palette,
                        title: "Mint Cultural Token",
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.CultureClickedEvent);
                        },
                      ),
                      MenuItem(
                        icon: Icons.change_history,
                        title: "Mint Historical Token",
                        onTap: () {
                          onIconPressed();
                      ...
                      MenuItem(
                        ...
                        title: "For Coffee Farmers",
                        onTap: () {
                          onIconPressed();
                          BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.CoffeeFarmerClickedEvent);
                        },
                      ),
                      MenuItem(
                        icon: Icons.adb,
                        title: "Crypto Game Si Bejo",
                        onTap: () {
                          onIconPressed();
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          "Blockchain Fixing The Internet",
