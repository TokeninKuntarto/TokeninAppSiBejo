...
{	
    ...
    public struct SurfaceModifierTarget
    {
        ...
        public Vector2 LastForceAppliedAt;
    }
    ...
    public class SurfaceModifier : MonoBehaviour 
	{
        ...
        public List<SurfaceModifierTarget> _targets;
        ...
        protected virtual void Update()
        {
            ...
            foreach(SurfaceModifierTarget target in _targets)
            {
                ...
                // horizontal force
                if (Time.time - target.LastForceAppliedAt.x > ForceApplicationCooldownDuration.x)
                {
                    ...
                    target.LastForceAppliedAt.MMSetX(Time.time);
                }                

                // vertical force
                if (Time.time - target.LastForceAppliedAt.y > ForceApplicationCooldownDuration.y)
                {
                    if (ForceApplicationMode == ForceApplicationModes.AddForce)
                    {
                    ...
                    target.LastForceAppliedAt.MMSetY(Time.time);
                }
            }            
